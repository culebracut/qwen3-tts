...
def main():
    ...
    #MODEL_PATH = "/data/Qwen3-TTS/Qwen/Qwen3-TTS-12Hz-1.7B-Base/"
    OUT_DIR = "myWavOutputs/JohnWayne"
    ensure_dir(OUT_DIR)
    ...
    # Reference audio(s)
    ref_audio_path_1 = "/data/audio/JohnWayne/YouTalkThinkTooMuch.wav"
    ref_audio_path_2 = "/data/audio/JohnWayne/INeverShot.wav"

    ref_audio_single = ref_audio_path_1
    ref_audio_batch = [ref_audio_path_1, ref_audio_path_2]

    ref_text_single = "You talk too much, think too much."
    ref_text_batch = [
    ...
    # Synthesis targets
    syn_text_single = "I think, you'd better, water my horse."
    syn_lang_single = "Auto"

    syn_text_batch = [
        "I think, you'd better, water my horse.",
